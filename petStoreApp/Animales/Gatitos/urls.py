...
from .views import GatitoCreate, GatitoList, GatitoUpdate, GatitoDelete, \
    gatito_collection, gatito_element, carrusel_gatos
from rest_framework.urlpatterns import format_suffix_patterns

urlpatterns = [
    path('carrusel-gatos/', carrusel_gatos, name="carrusel_gatos"),
